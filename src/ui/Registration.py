...
class RegistrationWidget(QWidget):
    ...
    def setup_form_fields(self, layout):
        ...
        layout.addLayout(self.create_form_field("Username", "Enter your username"))
        layout.addWidget(QWidget(), 20)  # Spacer
        layout.addLayout(self.create_form_field("Password", "Enter your password", is_password=True))
        layout.addWidget(QWidget(), 20)  # Spacer
        layout.addLayout(self.create_form_field("Confirm Password", "Confirm your password", is_password=True))
    ...
    def register_action(self):
        ...
        # Save credentials and notify user of successful registration
